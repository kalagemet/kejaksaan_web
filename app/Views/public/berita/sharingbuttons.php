...
<div class='sharebuttonwraper'>
    <a class="resp-sharing-button__link"
        href="https://facebook.com/sharer/sharer.php?u=<?php echo base_url("$_SERVER[REQUEST_URI]"); ?>" target="_blank"
    ...
    <!-- <a class="resp-sharing-button__link"
        href="mailto:?subject=<?php if(isset($page_title)) echo $page_title; ?>&amp;body=<?php echo base_url("$_SERVER[REQUEST_URI]"); ?>"
    ...
    <!-- <a class="resp-sharing-button__link"
        href="https://pinterest.com/pin/create/button/?url=<?php echo base_url("$_SERVER[REQUEST_URI]"); ?>&amp;media=<?php echo base_url("$_SERVER[REQUEST_URI]"); ?>&amp;description=<?php if(isset($page_title)) echo $page_title; ?>"
    ...
    <!-- <a class="resp-sharing-button__link"
        href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo base_url("$_SERVER[REQUEST_URI]"); ?>&amp;title=<?php if(isset($page_title)) echo $page_title; ?>&amp;summary=<?php if(isset($page_title)) echo $page_title; ?>&amp;source=<?php echo base_url("$_SERVER[REQUEST_URI]"); ?>"
