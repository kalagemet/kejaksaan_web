...
<body>
    ...
    <main id="main">
        <!-- Content -->
        <section id="artikel">
            <?php echo (!isset($not_found) or !$not_found) ? view('public/berita/header_page'): "<br/><br/>";?>
            <div class="container">
                <div class="row">
                    <div data-aos='fade-right' class="col-lg-8 d-lg-flex flex-lg-column">
                        <?php
                        echo (!isset($not_found) or !$not_found) ? $data[0]->post_content : view('errors/html/404.php',$data);
