            ...
            <div class="col-xl-6 col-md-6 mb-4">
                <form action="" method="GET" class="form-inline">
                    ...
                    <input class="form-control mr-sm-2" type="search" name="filter_string"
                        <?php if(isset($filter_string)) echo "value='$filter_string'"; ?> placeholder="cari artikel..."
                        aria-label="Search">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-6 col-md-4 mb-1">
                            <p>Post Date : '.$r['tanggal'].'</p>
                            <p>Post Status : <b style="color:'.($r['post_status']==='publish' ? "green":"red").'">'.$r['post_status'].'</b></p>
                            '.($r['post_status']==='publish' ? '<a href="'.base_url('cms/set-post-status/'.$r['id_post']).'" class="btn btn-secondary btn-icon-split">
                                    <span class="icon text-white-50">
                                    <i class="fas fa-arrow-right"></i>
                                </span>
                                <span class="text">Hide Post</span>
                            </a>' : '
                        ...
                        <div class="col-xl-6 col-md-4 mb-1">
                            <p>Post Edit : '.$r['post_edit'].'</p>
                            <a href="'.base_url('cms/update_post?id='.$r['id_post']).'&post='.$r['post_title'].'" class="btn btn-warning btn-icon-split">
                                <span class="icon text-white-50">
                                    <i class="fas fa-exclamation-triangle"></i>
                                </span>
                                <span class="text">Edit</span>
                            </a>
                            <a href="'.base_url('cms/delete-post/'.$r['id_post']).'" class="btn btn-danger btn-icon-split">
                                <span class="icon text-white-50">
